...
Factions in HeelKawn are emergent identities from deterministic history.
...
## Early Identity Seeds

### Open Hearth Clusters

- Origin region: low-scar recovery zones
...
- Origin region: frequently bloodied regions
