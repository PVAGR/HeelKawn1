...
- [x] 2026-05-01: Memory files initialized
- [x] 2026-04-30: Cultural architectural styles documented
- [x] 2026-04-30: First-play orientation (F10 → 35)
- [x] 2026-04-30: Planner spike guardrails
- [x] 2026-04-29: Major performance overhaul
- [x] 2026-04-29: WorldEvents/Stockpile API fix
- [x] 2026-04-27: Phase 4 playtest slice
- [x] 2026-04-27: Observer HUD polish
- [x] Kernel complete (memory → meaning → persistence → culture)

---

## How to Use This File

1. **AI**: Pick the highest-priority pending task that matches your capabilities
2. **After completing**: Move to "Completed" with date and brief description
3. **New tasks**: Add to "Pending" at the bottom of the section
4. **Blocked tasks**: Add `[BLOCKED: reason]` at the end of the line
