...
func _create_emergent_pattern() -> Dictionary:
	...
	pattern.type = _generate_pattern_type()
	pattern.description = _generate_pattern_description(pattern.type)
	pattern.effects = _generate_pattern_effects(pattern.type)
