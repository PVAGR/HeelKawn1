...
- [x] assets/sprites/items/paper.png (stack of sheets)
- [x] assets/sprites/items/leather.png (tanned hide)
- [x] assets/sprites/items/ink.png (inkwell)
- [x] assets/sprites/items/pen.png (quill)
- [x] assets/sprites/items/book.png (closed book)
- [x] assets/sprites/items/written_book.png (open/decorated)
- [x] assets/sprites/decor/banner_settlement.png (fabric flag)
- [x] assets/sprites/decor/shrine_stone.png (small altar)
- [x] assets/sprites/decor/foliage_grass.png (clump)
- [x] assets/sprites/decor/fire_smoke.png (campfire particles)
- [x] *.import files (copy from berry.png.import)
...
Current phase: World.gd enhancements.
