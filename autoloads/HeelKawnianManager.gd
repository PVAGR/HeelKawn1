...
static func ensure_identity_for_pawn(pawn) -> String:
...
static func log_heelkawn_event(soul_id: String, event_type: String, payload: Dictionary, rationale: String, inputs_snapshot: Dictionary, tick: int) -> void:
    var event = {
