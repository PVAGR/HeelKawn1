...
func _init_buildings() -> void:
	BUILDINGS = {
		...
		# === Phase 5A: Wooden Structures ===
		"woodshop": {
			"name": "Woodshop",
			"description": "Carpentry workshop. Wood-based crafting, tool repair, profession development.",
			"feature_type": TileFeature.Type.WOODSHOP,
			"job_type": Job.Type.BUILD_WOODSHOP,
			"cost": {"wood": 4, "stone": 1},
			"buffs": {"enables_carpentry": true, "craft_speed_bonus": 0.5, "profession": "carpenter"},
			"requires_tech": ["woodworking"],
			"work_ticks": 45,
			"category": CAT_PRODUCTION,
			"passable": true,
		...
		"market_stall": {
			"name": "Market Stall",
			"description": "Goods trading post. Sells food, tools, crafts. Enables merchant profession.",
			"feature_type": TileFeature.Type.MARKET_STALL,
			"job_type": Job.Type.BUILD_MARKET_STALL,
			"cost": {"wood": 3, "stick": 2},
			"buffs": {"enables_market_trading": true, "trade_income": 1.0, "profession": "merchant"},
			"requires_tech": ["commerce"],
			"work_ticks": 30,
			"category": CAT_TRADE,
			"passable": true,
		...
		"cook_hut": {
			"name": "Cook Hut",
			"description": "Food preparation hut. Cooks meals, stews, and preserves. Enables cook profession.",
			"feature_type": TileFeature.Type.COOK_HUT,
			"job_type": Job.Type.BUILD_COOK_HUT,
			"cost": {"wood": 3, "stone": 1},
			"buffs": {"enables_cooking": true, "food_quality": 1.0, "profession": "cook"},
			"requires_tech": [],
			"work_ticks": 35,
			"category": CAT_HOUSING,
			"passable": true,
		...
		"dining_table": {
			"name": "Dining Table",
			"description": "Community eating table. Mood boost when eating together.",
			"feature_type": TileFeature.Type.DINING_TABLE,
			"job_type": Job.Type.BUILD_DINING_TABLE,
			"cost": {"wood": 2},
			"buffs": {"mood_boost": 3.0, "community_eating": true},
			"requires_tech": [],
			"work_ticks": 15,
			"category": CAT_HOUSING,
			"passable": true,
		...
		"chair": {
			"name": "Chair",
			"description": "Simple seating. Rest recovery bonus when sitting.",
			"feature_type": TileFeature.Type.CHAIR,
			"job_type": Job.Type.BUILD_CHAIR,
			"cost": {"wood": 1},
			"buffs": {"rest_recovery": 1.0},
			"requires_tech": [],
			"work_ticks": 10,
			"category": CAT_HOUSING,
			"passable": true,
		...
		"farm_field": {
			"name": "Farm Field",
			"description": "Tilled field for planting crops. Yields food per harvest cycle.",
			"feature_type": TileFeature.Type.FARM_FIELD,
			"job_type": Job.Type.BUILD_FARM_FIELD,
			"cost": {"wood": 1, "seeds": 1},
			"buffs": {"crop_yield": 4, "growth_ticks": 2400, "nutrition": 60},
			"requires_tech": ["farming"],
			"work_ticks": 40,
			"category": CAT_AGRICULTURE,
			"passable": true,
		...
		"boat_workshop": {
			"name": "Boat Workshop",
			"description": "Boat building and repair. Enables fishing boat construction, fisher gear.",
			"feature_type": TileFeature.Type.BOAT_WORKSHOP,
			"job_type": Job.Type.BUILD_BOAT_WORKSHOP,
			"cost": {"wood": 5, "stone": 2},
			"buffs": {"enables_boatbuilding": true, "fish_yield_bonus": 2.0, "profession": "boatwright"},
			"requires_tech": ["boatbuilding"],
			"work_ticks": 50,
			"category": CAT_MARITIME,
			"passable": true,
		...
		"counter": {
			"name": "Counter",
			"description": "Market counter for displaying and selling goods.",
			"feature_type": TileFeature.Type.COUNTER,
			"job_type": Job.Type.BUILD_COUNTER,
			"cost": {"wood": 2, "stick": 1},
			"buffs": {"trade_display": true, "trade_income": 0.5},
			"requires_tech": ["commerce"],
			"work_ticks": 20,
			"category": CAT_TRADE,
			"passable": true,
